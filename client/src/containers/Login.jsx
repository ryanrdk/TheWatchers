...
import LoginView from '../components/ViewLogin';
      ...
      <div>
        <div className='App'>
          <header className='App-header'>
            {/* <LoginCard /> */}
            <GoogleLogin
              clientId='575180197639-t4sul1unsb6fuot757sic44qg4odeam6.apps.googleusercontent.com'
              scope='email'
              prompt='select_account'
              hostedDomain='student.wethinkcode.co.za'
              ...
              render={renderProps => (
                <LoginView onSignInClick={renderProps.onClick}/>
                // <button
                //   type='button'
